        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="btn-group" role="group" aria-label="">
                    <button  onclick="mostrar()" type="submit" name="accion" <?php echo ($accion == "Seleccionar") ? "disabled" : ""; ?> value="Agregar" class="btn btn-success">Agregar</button>
...
function mostrar() {
    ...
    confirm('¿Se completaron todos los campos anteriores?');
}
</script>
